...
/**
 * Strings for component 'enrol', language 'id', version '4.5'.
 *
 * @package     enrol
 * @category    string
...
$string['custominstancename'] = 'Nama model kustom';
$string['customwelcomemessage'] = 'Pesan selamat datang kustom';
$string['customwelcomemessage_help'] = 'Format yang diterima: Teks biasa atau format Moodle-otomatis. Tag HTML dan tag multi-bahasa juga diterima, serta placeholder berikut:
<ul>
<li>Nama kursus {$a->coursename}</li>
<li>Tautan ke laman profil pengguna {$a->profileurl}</li>
<li>Email pengguna {$a->email</li>
<li>Nama lengkap pengguna {$a->fullname}</li>
<li>Nama depan pengguna {$a->firstname}</li>
<li>Nama belakang pengguna {$a->lastname}</li>
<li>Peran kursus pengguna {$a->courserole}</li>
</ul>';
$string['customwelcomemessageplaceholder'] = 'Hai {$a->firstname}, Anda terdaftar dalam kursus {$a->coursename}.';
...
$string['eventuserenrolmentupdated'] = 'Pendaftaran pengguna diperbarui';
...
$string['extremovedaction_help'] = 'Pilih aksi yang akan dilakukan ketika pendaftaran pengguna menghilang dari sumber pendaftaran eksternal. Harap dicatat bahwa beberapa data dan setelan pengguna dihapus dari kursus selama pembatalan kursus.';
...
$string['plugindisabled'] = 'pengaya pendaftaran {$a} dinonaktifkan';
...
$string['rolefromsystem'] = '{$a->role} (Ditetapkan pada tingkat situs)';
$string['rolefromthiscourse'] = '{$a->role} (Ditetapkan pada kursus ini)';
$string['sendcoursewelcomemessage'] = 'Kirim pesan selamat datang kursus';
$string['sendcoursewelcomemessage_help'] = 'Saat mendaftarkan pengguna atau kelompok dalam kursus, mereka mungkin akan dikirimi surel pesan selamat datang. Jika dikirim dari kontak kursus (secara bawaan adalah pengajar), dan lebih dari satu pengguna memiliki peran ini, surel akan dikirim dari pengguna pertama yang diberi peran tersebut.';
...
$string['timeended'] = 'Waktu berakhir';
$string['timeenrolled'] = 'Waktu terdaftar';
$string['timereaggregated'] = 'Waktu dikumpulkan kembali';
$string['timestarted'] = 'Waktu dimulai';
...
$string['unenrolme'] = 'Batalkan pendaftaran saya dari kursus ini';
