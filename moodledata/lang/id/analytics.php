...
/**
 * Strings for component 'analytics', language 'id', version '4.5'.
 *
 * @package     analytics
 * @category    string
...
$string['errorimport'] = 'Galat saat mengimpor berkas JSON yang disediakan.';
...
$string['privacy:metadata:analytics:analyticsmodels'] = 'Model Analitik';
$string['privacy:metadata:analytics:analyticsmodels:usermodified'] = 'Pengguna yang memodifikasi model';
$string['privacy:metadata:analytics:analyticsmodelslog'] = 'Log yang digunakan untuk Model Analitik';
$string['privacy:metadata:analytics:analyticsmodelslog:usermodified'] = 'Pengguna yang memodifikasi log';
...
$string['privacy:metadata:analytics:indicatorcalc:value'] = 'Nilai terhitung';
