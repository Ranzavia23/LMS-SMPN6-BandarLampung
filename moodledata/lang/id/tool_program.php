...
/**
 * Strings for component 'tool_program', language 'id', version '4.5'.
 *
...
$string['addnewemptycourse'] = 'Tambahkan kursus kosong baru';
...
$string['allocatetoprograms'] = 'Alokasikan ke program...';
$string['allocateusers'] = 'Alokasikan pengguna';
$string['allocateuserstoprograms'] = 'Alokasikan pengguna ke program...';
$string['allocationallowedfrom'] = 'Alokasi diizinkan dari';
$string['allocationalloweduntil'] = 'Alokasi diizinkan hingga';
$string['allocationdate'] = 'Tanggal alokasi';
$string['allocationdateonorafter'] = 'Tanggal alokasi pada atau setelah';
$string['allocationdefaultvalue'] = 'Sama seperti yang didefinisikan dalam program (Bawaan)';
...
$string['allocationkey'] = 'Kunci alokasi';
$string['allocationkey_help'] = 'Tetapkan kunci yang harus dimasukkan pengguna untuk mengalokasikan diri mereka ke program ini. Hanya pengguna yang mengetahui kunci tersebut yang dapat menyelesaikan alokasi mandiri.';
$string['allocationmethod_direct'] = 'Alokasi langsung';
$string['allocationmethod_fee'] = 'Alokasi pembayaran';
$string['allocationmethod_self'] = 'Alokasi mandiri';
$string['allocationsource'] = 'Sumber alokasi';
$string['allocationsources'] = 'Sumber alokasi';
...
$string['allownewallocations'] = 'Izinkan alokasi baru';
$string['allownewallocations_desc'] = 'Izinkan pengguna untuk mengalokasikan sendiri kursus ke dalam program ini secara bawaan.';
$string['allownewallocations_help'] = 'Pilih apakah pengguna baru diizinkan untuk mengalokasikan diri mereka ke program ini:

* Ya: Pengguna yang belum dialokasikan ke program ini dapat mengalokasikan diri mereka ke program ini.

* Tidak: Pengguna yang belum dialokasikan ke program ini tidak dapat mengalokasikan diri mereka. Pengguna yang sudah ada yang telah dialokasikan ke program ini akan tetap dialokasikan ke program ini.';
...
$string['associatedcategorywarning'] = 'Untuk memasukkan program ini ke dalam katalog, program tersebut harus dikaitkan dengan suatu kategori. Pemilihan ini akan memastikan pengguna dapat dengan mudah menemukan program tersebut dalam suatu katalog.';
...
$string['categoryassociation'] = 'Asosiasi kategori';
$string['categoryassociation_help'] = 'Pengaturan ini memungkinkan Anda menentukan kategori kursus tempat program ini
akan dicantumkan dalam katalog. Kategori kursus membantu mengatur program, sehingga memudahkan pengguna untuk menemukan apa yang mereka cari.';
$string['categorytenantmismatch'] = 'Kategori yang dipilih diasosiasi dengan penyewa yang berbeda';
...
$string['custominstancename'] = 'Nama instans kustom';
$string['custominstancename_help'] = 'Timpa nama bawaan metode alokasi. Nama kustom akan ditampilkan di halaman alokasi program. Nama bawaan adalah nama metode alokasi.';
...
$string['direct'] = 'Alokasi langsung';
$string['directallocation'] = 'Alokasi langsung (manual)';
...
$string['errorinvalidpastenddate'] = 'Tanggal akhir tidak boleh sebelum tanggal mulai atau tanggal jatuh tempo';
...
$string['errornopermissiontoeditprogramdetails'] = 'Tidak ada izin untuk menyunting rincian program';
...
$string['errorpaymentaccount'] = 'Alokasi biaya tidak dapat diaktifkan tanpa menentukan akun pembayaran';
...
$string['existingcourses'] = 'Kursus yang ada';
...
$string['hideallocationinstancename'] = 'Jangan tampilkan nama instan di katalog';
...
$string['newemptycourse'] = 'Kursus kosong baru';
...
$string['overdueprograms'] = 'Program yang terlambat';
...
$string['paymentaccount_help'] = 'Pilih akun pembayaran yang akan digunakan untuk metode alokasi ini. Pembayaran akan diproses melalui akun yang dipilih.';
...
$string['price'] = 'Harga';
$string['price_help'] = 'Tetapkan harga yang harus dibayar pengguna untuk mengalokasikan diri mereka ke program ini. Masukkan jumlah dalam format 0.00 (misalnya, 25.00).';
$string['priceerror'] = 'Harga harus berupa angka.';
...
$string['program:configfeeallocation'] = 'Konfigurasikan instans pendaftaran alokasi pembayaran';
$string['program:configselfallocation'] = 'Konfigurasikan instans pendaftaran alokasi mandiri';
...
$string['program:manageuserfeeallocations'] = 'Memungkinkan untuk menyunitng dan menghapus alokasi pembayaran pengguna';
$string['program:manageuserselfallocations'] = 'Memungkinkan untuk menyunting dan menghapus alokasi diri pengguna';
$string['programcompleted'] = 'Program selesai';
$string['programcompletiondate'] = 'Tanggal penyelesaian program';
$string['programdates'] = 'Tanggal';
$string['programdates_help'] = 'Pilih tanggal yang berlaku untuk alokasi program ini:

* **Sama seperti yang ditetapkan dalam program:** Tanggal yang ditetapkan dalam program akan digunakan.
* **Pilih tanggal:** Anda dapat memilih tanggal tertentu (mulai, jatuh tempo, berakhir) untuk alokasi program ini.';
...
$string['programscountincategory'] = '{$a->count} program yang ditautkan ke kategori ini di Katalog Pembelajaran';
$string['programscountwithoutcategory'] = 'Program {$a->count} saat ini tidak terhubung ke kategori di Katalog Pembelajaran';
$string['programscustomfield'] = 'Kolom kustom program';
$string['programsetname'] = 'Nama set';
$string['programsincategoryx'] = 'Program dalam kategori \'{$a}\'';
$string['programslink'] = '<a href="{$a->href}">{$a->count} program</a>';
$string['programslink_plural'] = '<a href="{$a->href}">{$a->count} program</a>';
$string['programsnotlistedincatalogue'] = 'Program yang tidak tercantum dalam Katalog Pembelajaran';
...
$string['programvisibilityincatalogue'] = 'Visibilitas program dalam katalog';
$string['programvisibilityincatalogue_help'] = 'Pengaturan ini menentukan apakah program akan terlihat dalam katalog. Jika Anda mengaktifkan opsi ini,
pengguna yang menelusuri katalog akan dapat melihat dan berpotensi mengalokasikan diri ke program ini.<br /><br />
Menonaktifkan pengaturan ini akan menyembunyikan program dari katalog, tetapi pengguna dengan akses langsung (misalnya, melalui tautan atau izin tertentu) masih dapat berinteraksi dengannya.';
...
$string['recalculateprogramtask'] = 'Konten program berhasil diperbarui. Mungkin perlu waktu untuk menghitung ulang penyelesaian program untuk semua pengguna. Anda dapat melanjutkan navigasi di situs dengan aman.';
...
$string['set'] = 'Set';
$string['setcompletiondate'] = 'Set tanggal penyelesaian';
$string['setname'] = 'Nama';
...
$string['showincatalogue'] = 'Tampilkan program ini di katalog';
$string['showprograms'] = 'Tampilkan program';
$string['showprogramslisted'] = 'Tampilkan program yang tercantum dalam Katalog Pembelajaran dengan kategori \'{$a}\'';
$string['showprogramsnotlisted'] = 'Tampilkan program yang tidak tercantum dalam Katalog Pembelajaran';
