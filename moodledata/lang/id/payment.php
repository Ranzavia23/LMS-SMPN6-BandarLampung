...
/**
 * Strings for component 'payment', language 'id', version '4.5'.
 *
 * @package     payment
 * @category    string
...
$string['editpaymentaccount'] = 'Edit akun pembayaran';
...
$string['gotopaymentaccounts'] = 'Buat akun pembayaran menggunakan salah satu gateway ini di {$a}.';
