...
/**
 * Strings for component 'completion', language 'id', version '4.5'.
 *
 * @package     completion
 * @category    string
...
$string['completionpassgrade_help'] = 'Jika diaktifkan, aktivitas dianggap selesai saat siswa mendapatkan nilai kelulusan.';
