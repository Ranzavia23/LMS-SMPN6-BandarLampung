...
/**
 * Strings for component 'tool_behat', language 'id', version '4.5'.
 *
 * @package     tool_behat
 * @category    string
...
$string['fieldvalueargument_help'] = 'Argumen ini harus dilengkapi dengan nilai bidang. Ada banyak jenis bidang, termasuk yang sederhana seperti kotak centang, area pilihan atau teks, atau yang rumit seperti pemilih tanggal. Lihat dokumentasi dev <a href="https://moodledev.io/general/development/tools/behat" target="_blank">Ujian penerimaan</a> untuk detail nilai kolom yang diharapkan.';
