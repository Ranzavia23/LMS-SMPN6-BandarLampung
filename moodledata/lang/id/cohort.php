...
/**
 * Strings for component 'cohort', language 'id', version '4.5'.
 *
 * @package     cohort
 * @category    string
...
$string['contextcohortnotallowed'] = 'Kohor <b>{$a}</b> tidak diizinkan dalam konteks ini.';
...
$string['delcohortsconfirm'] = 'Akse ini akan menghapus kohor dan semua data terkait.';
$string['delcohortssuccess'] = 'Kohor terpilih telah dihapus';
$string['delconfirm'] = 'Aksi ini akan menghapus kohor \'{$a}\' dan semua data terkait.';
$string['delsuccess'] = 'Kohor terhapus';
...
$string['removeuserwarning'] = 'Menghapus pengguna dari kohor dapat mengakibatkan membatalkan pendaftaran pengguna dari berbagai program yang mencakup menghapus setelan pengguna, nilai, keanggotaan grup, dan informasi pengguna lainnya dari kursus yang terpengaruh.';
$string['search'] = 'Pencarian';
$string['searchcohort'] = 'Pencarian kohor';
$string['selectcohort'] = 'Pilih kohor';
...
* Baris pertama berisi daftar nama ruas yang menentukan format
