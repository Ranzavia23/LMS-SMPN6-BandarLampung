...
/**
 * Strings for component 'appointment', language 'id', version '4.5'.
 *
 * @package     appointment
 * @category    string
...
&nbsp;';
$string['closed'] = 'Tutup';
$string['completionattended'] = 'Pesan janji temu dan hadiri';
...
$string['fullybooked'] = 'Sudah penuh dipesan';
...
$string['placeholdersdesc_help'] = 'Tempat penampung memungkinkan Anda menambahkan konten dinamis, misalnya tempat penampung [firstname] akan diganti dengan nama depan pengguna dalam notifikasi yang dikirimkan ke pengguna.';
...
$string['venue'] = 'Lokasi';
$string['waitlistedat'] = '<strong>Daftar tunggu:</strong> {$a}';
