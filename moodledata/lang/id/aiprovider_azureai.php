...
/**
 * Strings for component 'aiprovider_azureai', language 'id', version '4.5'.
 *
...
$string['privacy:metadata'] = 'Pengaya penyedia API Azure Ai tidak menyimpan data pribadi apa pun.';
...
$string['privacy:metadata:aiprovider_azureai:responseformat'] = 'Saat membuat gambar, format responsnya';
