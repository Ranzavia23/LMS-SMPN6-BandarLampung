...
/**
 * Strings for component 'badges', language 'id', version '4.5'.
 *
 * @package     badges
 * @category    string
...
$string['activatesuccess'] = 'Akses ke lencana \'{$a}\' diaktifkan.';
...
$string['awardoncron'] = 'Banyak sekali pengguna yang mendapatkan lencana \'{$a->badgename}\'. Mungkin diperlukan beberapa waktu bagi semua pengguna untuk menerimanya.';
...
$string['badgesnavigation'] = 'Navigasi lencana';
...
$string['canvasregions'] = 'Wilayah Canvas Credentials';
$string['canvasregions_desc'] = 'Anda dapat mengonfigurasi konten wilayah Canvas Credentials. Setiap baris dipisahkan oleh karakter pipa dan terdiri dari 1) nama wilayah, 2) URL ransel, dan 3) URL API ransel.';
$string['claim'] = 'Klaim';
...
$string['contact'] = 'Kontak penerbit';
...
$string['deactivatesuccess'] = 'Akses ke lencana \'{$a}\' dinonaktifkan.';
...
$string['error:cannotsendtobackpack'] = '<strong>Tidak dapat menambahkan lencana ke ransel</strong><br />
Penyedia ransel Anda mengirimkan pesan ini: \'{$a}\'.<br /><br />
Anda dapat mencoba mengunduh lencana dan menambahkannya secara manual ke ransel Anda, atau coba lagi nanti.';
...
$string['error:notifycoursedate'] = 'Lencana yang terkait dengan penyelesaian kursus dan aktivitas tidak akan diterbitkan hingga tanggal mulai kursus ({$a}).';
...
$string['includeauthdetails'] = 'Hubungkan ke akun penyedia ransel';
$string['includeauthdetails_desc'] = 'Masukkan kredensial penerbit lencana Anda untuk terhubung ke penyedia tas ransel Anda.';
$string['includeauthdetails_help'] = 'Mengirimkan kredensial penerbit Anda dengan setiap lencana yang diekspor ke ransel ini.';
$string['includeauthdetailscanvas'] = 'Hubungkan ke akun penerbit Canvas Credentials';
$string['includeauthdetailscanvas_desc'] = 'Masukkan rincian Canvas Credentials Anda untuk menghubungkan akun penerbit Anda.';
$string['includeauthdetailscanvas_help'] = 'Lencana yang diekspor ke Canvas Credentials akan menampilkan organisasi Anda sebagai penerbit. Ini juga memungkinkan Anda melacak siapa yang menerima lencana dan mengelola pembaruan.';
$string['includeauthdetailscanvas_subtitle'] = '(Memerlukan paket Canvas Credentials berbayar)';
...
$string['namewithimagelink'] = 'Nama dengan gambar dan tautan';
...
$string['newbadgedeprecated'] = 'Anda telah dialihkan dari badges/newbadge.php. Harap dicatat bahwa badges/newbadge.php akan dihapus dalam waktu dekat. <br/>
Perbarui tautan dan markah untuk menggunakan lencana halaman saat ini/edit.php.';
...
$string['nomatchingawards'] = 'Belum ada penerima yang cocok yang memperoleh lencana ini.';
...
$string['numawards'] = 'Pengguna yang mendapatkan lencana \'{$a->badgename}\': <a href="{$a->link}">{$a->count}</a>.';
$string['numawardstat'] = 'Pengguna mendapatkan lencana \'{$a->badgename}\': {$a->awards}.';
...
$string['wrongrole'] = 'Peran yang ingin Anda gunakan belum ditugaskan kepada Anda.';
$string['year'] = 'Tahun';
