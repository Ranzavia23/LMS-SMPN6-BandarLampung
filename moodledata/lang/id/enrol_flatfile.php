...
/**
 * Strings for component 'enrol_flatfile', language 'id', version '4.5'.
 *
...
$string['pluginname_desc'] = 'Metode ini akan berulang kali memeriksa dan memproses berkas teks yang diformat khusus di lokasi yang Anda tentukan. Berkas tersebut adalah berkas yang dipisahkan koma yang diasumsikan memiliki empat atau enam bidang per baris:
