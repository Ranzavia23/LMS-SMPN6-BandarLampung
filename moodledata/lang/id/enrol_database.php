...
/**
 * Strings for component 'enrol_database', language 'id', version '4.5'.
 *
...
$string['newcourseenddate'] = 'Kolom tanggal akhir kursus baru';
$string['newcourseenddate_desc'] = 'Tentukan tanggal dalam format yyyy-mm-dd atau waktu Unix, atau biarkan kosong agar tanggal akhir kursus dihitung dari durasi kursus yang dikonfigurasi.';
...
$string['newcoursestartdate'] = 'Kolom tanggal mulai kursus baru';
$string['newcoursestartdate_desc'] = 'Tentukan tanggal dalam format yyyy-mm-dd atau waktu Unix, atau biarkan kosong agar tanggal mulai kursus ditetapkan ke tanggal saat ini.';
