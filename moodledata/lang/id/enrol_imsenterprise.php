...
/**
 * Strings for component 'enrol_imsenterprise', language 'id', version '4.5'.
 *
...
$string['allowunenrol'] = 'Izinkan data IMS untuk membatalkan pendaftaran siswa dan pengajar';
$string['allowunenrol_desc'] = 'Jika diaktifkan, pendaftaran kursus akan dihapus saat ditentukan di data Perusahaan.';
$string['basicsettings'] = 'Setelan dasar';
...
$string['categoryseparator_desc'] = 'Diperlukan saat \'Izinkan nomor ID kategori\' diaktifkan. Karakter untuk memisahkan nama kategori dan nomor ID.';
...
$string['createnewusers_desc'] = 'Data pendaftaran IMS Enterprise biasanya menjelaskan sekumpulan pengguna. Jika diaktifkan, akun dapat dibuat untuk setiap pengguna yang tidak ditemukan di basis data Moodle.

Pengguna dicari terlebih dahulu dengan nomor ID mereka, dan kemudian dengan nama pengguna Moodle mereka. Kata sandi tidak diimpor oleh plugin IMS Enterprise. Penggunaan plugin autentikasi direkomendasikan untuk mengautentikasi pengguna.';
...
$string['disableenrolmentandremoveallroles'] = 'Tangguhkan pendaftaran & hapus peran';
$string['disableenrolonly'] = 'Tangguhkan pendaftaran saja';
...
$string['noaction'] = 'Tidak ada aksi';
...
$string['removeenrolmentandallroles'] = 'Hapus pendaftaran & peran';
...
$string['unenrolaction'] = 'Aksi pembatalan pendaftaran';
$string['unenrolaction_desc'] = 'Aksi yang akan diambil ketika pengguna dibatalkan pendaftarannya dari sebuah kursus (hanya berlaku ketika setelan tidak mendaftar di atas diaktifkan).';
