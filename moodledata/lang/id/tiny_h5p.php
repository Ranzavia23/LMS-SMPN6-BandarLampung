...
/**
 * Strings for component 'tiny_h5p', language 'id', version '4.5'.
 *
 * @package     tiny_h5p
 * @category    string
...
$string['buttontitle'] = 'Sisipkan konten H5P';
...
$string['instructions'] = 'Anda dapat menyisipkan konten H5P dengan <strong> baik </strong> Sisipkan URL <strong> atau </strong> dengan mengunggah berkas H5P.';
...
$string['pluginname'] = 'Sisipkan H5P';
