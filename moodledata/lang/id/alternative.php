...
/**
 * Strings for component 'alternative', language 'id', version '4.5'.
 *
 * @package     alternative
 * @category    string
...
$string['csv2ndfield'] = 'Kolom ke-2 (tempat) harus berupa angka, dengan 0 = tanpa batas.';
$string['csv_help'] = 'Setiap baris terdiri dari Judul; Tempat; Tanggal; Deskripsi';
$string['csvbadfieldnb'] = 'Jumlah kolom salah: {$a} bukan 4.';
$string['csvunableopen'] = 'Tidak dapat membuka file CSV.';
$string['datecomment'] = 'Tanggal';
$string['datecomment_help'] = 'Kolom ini dapat berisi teks apa pun, tetapi dimaksudkan untuk tanggal atau interval tanggal.';
