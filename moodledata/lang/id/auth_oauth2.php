...
/**
 * Strings for component 'auth_oauth2', language 'id', version '4.5'.
 *
 * @package     auth_oauth2
 * @category    string
...
Jika Anda tidak melakukan ini, orang lain mungkin mencoba untuk membobol akun Anda.
...
Permintaan telah dibuat untuk menghubungkan masuk {$a->issuername}
{$a->linkedemail} ke akun Anda di \'{$a->sitename}\'
menggunakan alamat surel Anda.

Untuk mengonfirmasikan permintaan ini dan menghubungkan masuk ini, silakan klik tautan di bawah ini:

<a href="{$a->link}">Hubungkan akun Anda</a>


Jika Anda membutuhkan bantuan, silakan hubungi administrator situs.
{$a->admin}

Jika Anda tidak melakukan ini, orang lain mungkin mencoba untuk membahayakan akun Anda.
Silakan hubungi administrator situs segera.';
...
$string['privacy:metadata:auth_oauth2:email'] = 'Surel eksternal yang dipetakan ke akun ini.';
