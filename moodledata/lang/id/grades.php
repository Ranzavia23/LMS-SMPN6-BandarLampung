...
/**
 * Strings for component 'grades', language 'id', version '4.5'.
 *
 * @package     grades
 * @category    string
...
$string['aria-toggledropdown'] = 'Alihkan tarik-turun berikut';
$string['aria:dropdowngrades'] = 'Item nilai ditemukan';
