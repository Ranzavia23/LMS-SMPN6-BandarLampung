...
/**
 * Strings for component 'search', language 'id', version '4.5'.
 *
 * @package     search
 * @category    string
...
$string['error_indexing'] = 'Galat saat pengindeksan';
...
$string['performsearch'] = 'Lakukan pencarian';
...
$string['search:customfield'] = 'Kolom kustom kursus';
...
$string['sitewidesearch'] = 'Pencarian di seluruh situs';
