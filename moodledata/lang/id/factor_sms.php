...
/**
 * Strings for component 'factor_sms', language 'id', version '4.5'.
 *
 * @package     factor_sms
 * @category    string
...
$string['pluginname'] = 'SMS ponsel';
$string['privacy:metadata'] = 'Pengaya faktor ponsel SMS tidak menyimpan data pribadi apa pun.';
...
$string['settings:heading'] = 'Pengguna akan menerima SMS dengan kode 6 digit saat login, yang harus mereka masukkan untuk menyelesaikan proses login.';
