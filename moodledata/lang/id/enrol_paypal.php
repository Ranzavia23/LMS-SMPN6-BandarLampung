...
/**
 * Strings for component 'enrol_paypal', language 'id', version '4.5'.
 *
...
$string['privacy:metadata:enrol_paypal:enrol_paypal:receiver_email'] = 'Alamat surel utama penerima pembayaran (yaitu, \'merchant\').';
