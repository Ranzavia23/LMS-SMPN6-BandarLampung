...
/**
 * Strings for component 'tool_mfa', language 'id', version '4.5'.
 *
 * @package     tool_mfa
 * @category    string
...
$string['createdfromip'] = 'Dibuat dari IP';
...
$string['lastverified'] = 'Terakhir diverifikasi';
