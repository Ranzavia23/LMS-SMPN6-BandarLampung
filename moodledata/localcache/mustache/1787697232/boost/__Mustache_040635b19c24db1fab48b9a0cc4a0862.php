...
class __Mustache_040635b19c24db1fab48b9a0cc4a0862 extends Mustache_Template
{
...
';
        $buffer .= $indent . '        <div role="group" aria-labelledby="duedatefiltergrouplabel">
';
        $buffer .= $indent . '            <div class="h6 dropdown-header" role="presentation" id="duedatefiltergrouplabel">';
        $value = $context->find('str');
