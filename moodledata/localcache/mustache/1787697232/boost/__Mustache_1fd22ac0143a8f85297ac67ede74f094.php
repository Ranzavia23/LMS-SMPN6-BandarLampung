...
class __Mustache_1fd22ac0143a8f85297ac67ede74f094 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <div class="input-group searchbar w-100" role="search" aria-labelledby="searchinput-label-';
        $value = $this->resolveValue($context->find('uniqid'), $context);
        $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
        $buffer .= '">
';
