...
class __Mustache_240e63cf8dbe8a9443f874d6abf53845 extends Mustache_Template
{
...
';
        $buffer .= $indent . '            id="courseindexdrawercontrolsmenubutton"
';
...
';
        ...
        $buffer .= '"
';
        $buffer .= $indent . '            aria-controls="courseindexdrawercontrolsmenu">
';
        $buffer .= $indent . '        <i class="icon fa fa-ellipsis-v fa-fw m-0" aria-hidden="true"></i>
';
        $buffer .= $indent . '    </button>
';
        $buffer .= $indent . '    <div class="dropdown-menu dropdown-menu-right" role="menu" id="courseindexdrawercontrolsmenu" aria-labelledby="courseindexdrawercontrolsmenubutton">
';
...
';
        ...
        $buffer .= $this->sectionE33c0bb533527d1ee3483f1398bc6ede($context, $indent, $value);
    ...
    private function sectionE33c0bb533527d1ee3483f1398bc6ede(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
